...
import kz.kasip.order.ui.salesperson.SalespersonTab
import kz.kasip.order.ui.salesperson.SalespersonViewModel

@OptIn(ExperimentalFoundationApi::class)
@Composable
fun MainOrderScreen(
    viewModel: MainOrderViewModel = hiltViewModel(),
                            ...
                            0 -> {
                                SalespersonTab(
                                    ...
                                    navigateToOfferService = {
                                        salespersonViewModel.selectedOrderUi = it
                                        navigateToOfferService()
                                    }
                                )
                            }
